...
<main class="main">
    ...
    <div class="content">
        <div class="page-header">
            <div>
                <div class="page-header-title">Pengajuan PKL</div>
                <div class="page-header-sub">Total {{ $daftarPengajuan->count() }} pengajuan masuk</div>
            </div>
                        ...
                        <td>
                            ...
                            <div class="action-wrap">
                                <button class="btn-approve"
                                    onclick="showModal('approve', {{ $pengajuan->id }}, '{{ $pengajuan->nama_perusahaan }}')">
                                    ✅ Setujui
                                </button>
                                <button class="btn-reject"
                                    onclick="showModal('reject', {{ $pengajuan->id }}, '{{ $pengajuan->nama_perusahaan }}')">
                                    ❌ Tolak
                                </button>
                            </div>
                            @else
...
<script>
    ...
    // Modal
    function showModal(type, id, perusahaan) {
        ...
        form.action = `/dashboard/wakasek/pengajuan/${id}/${type}`;
