...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        html, body { min-height: 100vh; font-family: var(--font); background: var(--bg); transition: background .4s ease; }
        ...
        .rp svg { width: 15px; height: 15px; flex-shrink: 0; }

        .rp:hover {
            background: rgba(102,126,234,.18);
            border-color: rgba(102,126,234,.38);
            color: var(--text);
        }
        ...
        .rp.on {
            ...
            color: var(--text);
            box-shadow: 0 0 16px rgba(102,126,234,.15);
        }
...
<div class="page">
    ...
    <div class="right">
        <div class="card">
            ...
            <div class="role-lbl">Masuk sebagai</div>
            <div class="roles">
                <button class="rp on" type="button" onclick="pickRole(this,'siswa')">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    Siswa
                </button>
                <button class="rp" type="button" onclick="pickRole(this,'guru')">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg>
                    Guru
                </button>
                <button class="rp" type="button" onclick="pickRole(this,'hubin')">
                ...
                <button class="rp" type="button" onclick="pickRole(this,'admin')">
            ...
            <form method="POST" action="{{ route('login') }}" id="frm">
                @csrf
                <input type="hidden" name="role_hint" id="rv" value="siswa">
