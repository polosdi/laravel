...
<div class="layout">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('siswa.pengajuan') }}" class="nav-item @yield('nav_pengajuan')">
            ...
            <a href="{{ route('siswa.laporan') }}" class="nav-item @yield('nav_laporan')">
                <div class="nav-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg></div>
            ...
            <a href="{{ route('siswa.log') }}" class="nav-item @yield('nav_log')">
                <div class="nav-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
        ...
        <div class="sidebar-footer">
            <div class="user-card">
                <div class="user-avatar">{{ strtoupper(substr(auth()->user()->nama_lengkap ?? 'S', 0, 2)) }}</div>
                <div class="user-info">
                    <div class="user-name">{{ auth()->user()->nama_lengkap ?? 'Siswa' }}</div>
                    <div class="user-role">{{ auth()->user()->kelas ?? 'XI' }} {{ auth()->user()->jurusan ?? 'TKJ' }}</div>
                </div>
            </div>
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="nav-item danger" style="width:100%;background:none;border:none;text-align:left;cursor:pointer">
                    <div class="nav-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg></div>
