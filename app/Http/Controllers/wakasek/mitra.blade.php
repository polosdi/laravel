...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .mitra-table { width: 100%; border-collapse: collapse; }
        .mitra-table th {
        ...
        .alamat-cell {
            ...
            text-overflow: ellipsis; color: var(--text-muted); font-size: 13px;
        }
...
<main class="main">
    ...
    <div class="content">
        ...
        <div class="page-header">
            <div>
                <div class="page-header-title">Total {{ $daftarMitra->count() }} mitra industri terdaftar</div>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-wrap">
                                <button class="btn-edit" onclick="bukaModalEdit({{ $mitra->id }}, '{{ addslashes($mitra->nama_perusahaan) }}', '{{ addslashes($mitra->alamat_perusahaan) }}', '{{ addslashes($mitra->website) }}')">
                                    ✏️ Edit
                                </button>
                                <button class="btn-hapus" onclick="bukaModalHapus({{ $mitra->id }}, '{{ addslashes($mitra->nama_perusahaan) }}')">
                                    🗑️ Hapus
                                </button>
                            </div>
                        </td>
...
<div class="modal-overlay" id="modalTambah">
    <div class="modal">
        <div class="modal-header">
            <div class="modal-title">➕ Tambah Mitra Industri</div>
            <button class="modal-close" onclick="tutupModal('modalTambah')">✕</button>
        </div>
        <form method="POST" action="{{ route('wakasek.mitra.store') }}">
            @csrf
            <div class="form-group">
                <label class="form-label">Nama Perusahaan *</label>
                <input type="text" name="nama_perusahaan" class="form-input" placeholder="Contoh: PT Teknologi Nusantara" required>
            </div>
            <div class="form-group">
                <label class="form-label">Alamat Perusahaan</label>
                <textarea name="alamat_perusahaan" class="form-input" placeholder="Alamat lengkap perusahaan"></textarea>
            </div>
            <div class="form-group">
                <label class="form-label">Website</label>
                <input type="url" name="website" class="form-input" placeholder="https://contoh.com">
            </div>
...
<div class="modal-overlay" id="modalEdit">
    <div class="modal">
        <div class="modal-header">
            <div class="modal-title">✏️ Edit Mitra Industri</div>
        ...
        <form method="POST" id="formEdit" action="">
            ...
            <div class="form-group">
                <label class="form-label">Nama Perusahaan *</label>
                <input type="text" name="nama_perusahaan" id="edit_nama" class="form-input" required>
            </div>
            <div class="form-group">
                <label class="form-label">Alamat Perusahaan</label>
                <textarea name="alamat_perusahaan" id="edit_alamat" class="form-input"></textarea>
            </div>
            <div class="form-group">
                <label class="form-label">Website</label>
                <input type="url" name="website" id="edit_website" class="form-input" placeholder="https://contoh.com">
            </div>
            <div class="modal-footer">
...
<div class="modal-overlay" id="modalHapus">
    <div class="modal" style="max-width:420px; text-align:center;">
        ...
        <div class="modal-title" style="margin-bottom:10px;">Hapus Mitra Industri?</div>
        <p style="color:var(--text-muted); font-size:14px; margin-bottom:24px;">
            Data <strong id="hapus_nama"></strong> akan dihapus permanen dan tidak bisa dikembalikan.
        </p>
...
<script>
    ...
    function bukaModalEdit(id, nama, alamat, website) {
        document.getElementById('formEdit').action = `/wakasek/mitra/${id}`;
    ...
    function bukaModalHapus(id, nama) {
        document.getElementById('formHapus').action = `/wakasek/mitra/${id}`;
